...
class MYPDF extends TCPDF {
	...
	public function ColoredTable($header,$data) {
		...
		foreach($data as $row) {
            ...
            $this->Cell($w[3], 10, $row["tipe"], 'LR', 0, 'C', $fill);
            $this->Cell($w[4], 10, $row["tarif"], 'LR', 0, 'C', $fill);
...
// column titles
$header = array('Id Lokasi', 'Nama Lokasi', 'Alamat', 'Tipe', 'Tarif');
